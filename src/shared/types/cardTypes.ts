...
export type TAdditionalCardFields<T extends CardSubType> = T extends CardSubType.creature
	? {
...
export type TCreatureCard = TBaseCard & TAdditionalCardFields<CardSubType.creature>;
export type TEquipmentCard = TBaseCard & TAdditionalCardFields<CardSubType.equipment>;
